...
@PipelineStage(name = "JavaWithMaven Artifact Build Pipeline Stage", stage = StageType.ARTIFACT_BUILD)
class JavaWithMavenArtifactBuildPaPipelineStage implements IPipelineStage {
